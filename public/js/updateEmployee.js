...
function populateUpdateEmployeeFields(id) {
    ...
    console.log(convertFormFriendlyDateString(employeeToUpdate.formatted_date_of_birth));
    updateBirthdateInput.value = convertFormFriendlyDateString(employeeToUpdate.formatted_date_of_birth);
}
